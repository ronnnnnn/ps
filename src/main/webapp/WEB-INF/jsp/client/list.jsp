...
<section class="z-con">
    ...
    <article class="articles fr">
        ...
        <input id="cid" type="hidden" value="${catId}"></article>
        <div class="news">
            <ul class="new-list">
                    <li class="list" ng-repeat="myArt in articleList" >
                        <div class="first">
                            <div>
                                <a href="{{myArt.url}}">
                                  <h1>{{myArt.title}}</h1>
                                ...
                                <p>{{myArt.paper}}</p>
                                <div class="tools">
                                    <span>{{myArt.createTime | date : 'yyyy-MM-dd HH:MM:SS'}}</span>
                                    <a href="{{myArt.url}}">【全文】</a>
                                </div>
                            </div>
                        </div>
                    </li>
